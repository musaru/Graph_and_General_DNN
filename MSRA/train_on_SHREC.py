...
os.chdir('.home/musa/Musa_Related/PhD/Skelton_Depth_VedioSign Language/Depth_Skelton/Github/DG-STA-master')# Navigate
...
def init_data_loader(data_cfg):
    ...
    train_data, test_data = split_train_test(test_subject_id, data_cfg)
