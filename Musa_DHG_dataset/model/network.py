...
#Spatial temporal and temporal spatial with nested nn1 
#DG-BiSTA-MRC

'''
'''
import os
os.chdir('/home/musa/Musa_Related/PhD/Skelton_Depth_VedioSign Language/Depth_Skelton/Depththreedatasetcode/DHG_dataset_DG-STA')
print(os.getcwd())
...
class DG_STA(nn.Module):
    ...
    def forward(self, x):
        ...
        res2=self.res_map2(inmp)
        res2=F.pad(res2, pad=(0, 0, 2, 0), mode='constant', value=0)
        ...
        #temporal
        sx = self.t_att(res) # #input=32*176*128    output=32*176*256
        #print('x shape of first attention',sx.shape)  
        #temporal
        #sx=self.res_map(original)+sx
...
'''
'''
#Spatial temporal and temporal spatial
